...
namespace Voodoo.Data.DbHelper
{
    ...
    public class SQLiteHelper : IDbHelper
    {
        ...
        /// </summary>
        /// <param name="connStr"></param>
        public SQLiteHelper(string connStr, int Times)
        {
            this.Conn = new SQLiteConnection(connStr);
        ...
        {
            return this.ExecuteDataSet(CmdType, CmdText, null, (SQLiteTransaction)Transaction);
        }
        #endregion
        ...
        {
            this.CreateCmd(CmdType, CmdText.SqlStrTopToLimit(), CmdParameters, (SQLiteTransaction)Transaction);
        ...
        {
            return this.ExecuteDataTable(CmdType, CmdText, null, (SQLiteTransaction)Transaction);
        }
        #endregion
        ...
        {
            return this.ExecuteNonQuery(CmdType, CmdText, null, (SQLiteTransaction)Transaction);
        }
        #endregion
        ...
        {
            return this.ExecuteReader(CmdType, CmdText, null, (SQLiteTransaction)Transaction, ConnOwnership);
        }
        #endregion
        ...
        {
            return this.ExecuteScalar(CmdType, CmdText, null, (SQLiteTransaction)Transaction);
        }
        #endregion
        ...
        public DataTable PageListViewSort(string Tables, string PrimaryKey, string Sort, int CurrentPage, int PageSize, string Fields, string Filter, string group)
        {
            ...
            string str_sql = "SELECT " + Fields + " FROM " + Tables + Filter + group + Sort + " LIMIT " + strStartRow + "," + PageSize;
        ...
        /// <param name="group">Group表达式 不需要“group”</param>
        /// <returns></returns>
        public DataTable PageListViewSort(string Tables, string PrimaryKey, string Sort, int CurrentPage, int PageSize, string Fields, string Filter, string group, string having)
        {
            if (CurrentPage <= 0)
            {
                CurrentPage = 1;
            ...
            string str_sql = "SELECT " + Fields + " FROM " + Tables + Filter + group + having + Sort + " LIMIT " + strStartRow + "," + PageSize;
            DataTable dt = ExecuteDataTable(CommandType.Text, str_sql);
        ...
        public int PageCountSort(string Tables, string Filter, string group)
        {
            ...
            {
                group = " GROUP BY " + group + " ";
                return Convert.ToInt32(ExecuteScalar(CommandType.Text, "select count(0) from (select count(0) from " + Tables + Filter + group + ") as tt"));
            }
            else
            {
                group = "";
        ...
        /// <returns></returns>
        public int PageCountSort(string Tables, string Filter, string group, string having)
        {
            if (!Filter.IsNullOrEmpty())
            {
                Filter = " where " + Filter + " ";
            ...
            {
                group = " GROUP BY " + group + " ";
                return Convert.ToInt32(ExecuteScalar(CommandType.Text, "select count(0) from (select count(0) from " + Tables + Filter + group + having + ") as tt"));
            }
            else
            {
                group = "";
                return Convert.ToInt32(ExecuteScalar(CommandType.Text, "select count(0) from " + Tables + Filter + group + having));
            }
        }
        #endregion
    }

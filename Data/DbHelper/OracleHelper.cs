...
namespace Voodoo.Data.DbHelper
{
    public class OracleHelper :IDbHelper
    {
        ...
        /// </summary>
        /// <param name="connStr"></param>
        public OracleHelper(string connStr, int Times)
        {
            this.Conn = new OracleConnection(connStr);
        ...
        #region 添加OracleCommand 的参数
        /// <summary>
        /// 添加OracleCommand 的参数
        /// </summary>
        /// <param name="CmdParameters">OracleCommand 的参数</param>
        public void Add(OracleParameter[] CmdParameters)
        {
            foreach (OracleParameter parameter in CmdParameters)
            {
        ...
        {
            Cmd.Parameters.Add(new OracleParameter(ParamName, DbType)).Value = Value == null ? "" : Value;
        }
        /// <summary> 
        ...
        {
            Cmd.Parameters.Add(new OracleParameter(ParamName, DbType)).Value = Value;
        }
        /// <summary> 
        ...
        /// <remarks></remarks> 
        public void Add(string ParamName, OracleType DbType, object Value, int Size)
        {
            Cmd.Parameters.Add(new OracleParameter(ParamName, DbType, Size)).Value = Value == null ? "" : Value;
        }
        /// <summary> 
        ...
        /// <param name="NoNull"></param> 
        /// <remarks></remarks> 
        public void Add(string ParamName, OracleType DbType, object Value, int Size, bool NoNull)
        {
            Cmd.Parameters.Add(new OracleParameter(ParamName, DbType, Size)).Value = Value;
        }
        /// <summary> 
        ...
        {
            OracleParameter aa = new OracleParameter(ParamName, DbType);
        ...
        #region OracleCommand 的此实例使用的OracleConnection开启
        /// <summary>
        ...
        private void CreateCmd(CommandType CmdType, string CmdText, DbParameter[] CmdParameters, OracleTransaction Transaction)
        {
            ...
            {
                this.Add((OracleParameter[])CmdParameters);
            }
        ...
        #region 对连接执行 Transact-SQL 语句并返回DataSet/参数：CommandType CmdType, string CmdText, OracleTransaction Transaction
        /// <summary>
        /// 对连接执行 Transact-SQL 语句并返回DataSet
        /// </summary>
        /// <param name="CmdType">指定如何解释命令字符串</param>
        ...
        {
            return this.ExecuteDataSet(CmdType, CmdText, null, (OracleTransaction)Transaction);
        }
        #endregion

        #region 对连接执行 Transact-SQL 语句并返回DataSet/参数：CommandType CmdType, string CmdText, OracleConnection[] CmdParameters
        /// <summary>
        /// 对连接执行 Transact-SQL 语句并返回DataSet
        /// </summary>
        /// <param name="CmdType">指定如何解释命令字符串</param>
        ...
        #region 对连接执行 Transact-SQL 语句并返回DataSet/参数：CommandType CmdType, string CmdText, OracleConnection[] CmdParameters, OracleTransaction Transaction
        /// <summary>
        /// 对连接执行 Transact-SQL 语句并返回DataSet
        /// </summary>
        /// <param name="CmdType">指定如何解释命令字符串</param>
        ...
        {
            this.CreateCmd(CmdType, CmdText, CmdParameters, (OracleTransaction)Transaction);
            OracleDataAdapter adapter = new OracleDataAdapter(this.Cmd);
        ...
        #region 对连接执行 Transact-SQL 语句并返回DataTable/参数：CommandType CmdType, string CmdText, OracleTransaction Transaction
        /// <summary>
        /// 对连接执行 Transact-SQL 语句并返回DataTable
        /// </summary>
        /// <param name="CmdType">指定如何解释命令字符串</param>
        ...
        {
            return this.ExecuteDataTable(CmdType, CmdText, null, (OracleTransaction)Transaction);
        }
        #endregion

        #region 对连接执行 Transact-SQL 语句并返回DataTable/参数：CommandType CmdType, string CmdText, OracleConnection[] CmdParameters
        /// <summary>
        /// 对连接执行 Transact-SQL 语句并返回DataTable
        /// </summary>
        /// <param name="CmdType">指定如何解释命令字符串</param>
        ...
        #region 对连接执行 Transact-SQL 语句并返回DataTable/参数：CommandType CmdType, string CmdText, OracleConnection[] CmdParameters, OracleTransaction Transaction
        /// <summary>
        /// 对连接执行 Transact-SQL 语句并返回DataTable
        /// </summary>
        /// <param name="CmdType">指定如何解释命令字符串</param>
        ...
        #region 对连接执行 Transact-SQL 语句并返回受影响的行数/参数：CommandType CmdType, string CmdText, OracleConnection[] CmdParameters
        /// <summary>
        /// 对连接执行 Transact-SQL 语句并返回受影响的行数
        /// </summary>
        /// <param name="CmdType">指定如何解释命令字符串</param>
        ...
        #region 对连接执行 Transact-SQL 语句并返回受影响的行数/参数：CommandType CmdType, string CmdText, OracleTransaction Transaction
        /// <summary>
        /// 对连接执行 Transact-SQL 语句并返回受影响的行数
        /// </summary>
        /// <param name="CmdType">指定如何解释命令字符串</param>
        ...
        {
            return this.ExecuteNonQuery(CmdType, CmdText, null, (OracleTransaction)Transaction);
        }
        #endregion

        #region 对连接执行 Transact-SQL 语句并返回受影响的行数/参数：CommandType CmdType, string CmdText, OracleConnection[] CmdParameters, OracleTransaction Transaction
        /// <summary>
        /// 对连接执行 Transact-SQL 语句并返回受影响的行数
        /// </summary>
        /// <param name="CmdType">指定如何解释命令字符串</param>
        ...
        #region 将CommandText发送到Connection，并使用CommandBehavior值之一生成一个SqlDataReader/参数：CommandType CmdType, string CmdText, OracleConnection[] CmdParameters
        /// <summary>
        /// 将CommandText发送到Connection，并使用CommandBehavior值之一生成一个SqlDataReader
        /// </summary>
        /// <param name="CmdType">指定如何解释命令字符串</param>
        ...
        #region 将CommandText发送到Connection，并使用CommandBehavior值之一生成一个SqlDataReader/参数CommandType CmdType, string CmdText, OracleTransaction Transaction
        /// <summary>
        /// 将CommandText发送到Connection，并使用CommandBehavior值之一生成一个SqlDataReader
        /// </summary>
        /// <param name="CmdType">指定如何解释命令字符串</param>
        ...
        #region 将CommandText发送到Connection，并使用CommandBehavior值之一生成一个SqlDataReader/参数：CommandType CmdType, string CmdText, OracleTransaction Transaction, ConnClose ConnOwnership
        /// <summary>
        /// 将CommandText发送到Connection，并使用CommandBehavior值之一生成一个SqlDataReader
        /// </summary>
        /// <param name="CmdType">指定如何解释命令字符串</param>
        ...
        {
            return this.ExecuteReader(CmdType, CmdText, null, (OracleTransaction)Transaction, ConnOwnership);
        }
        #endregion

        #region 将CommandText发送到Connection，并使用CommandBehavior值之一生成一个SqlDataReader/参数：CommandType CmdType, string CmdText, OracleConnection[] CmdParameters, ConnClose ConnOwnership
        /// <summary>
        /// 将CommandText发送到Connection，并使用CommandBehavior值之一生成一个SqlDataReader
        /// </summary>
        /// <param name="CmdType">指定如何解释命令字符串</param>
        ...
        #region 将CommandText发送到Connection，并使用CommandBehavior值之一生成一个SqlDataReader/参数：CommandType CmdType, string CmdText, OracleConnection[] CmdParameters, OracleTransaction Transaction, ConnClose ConnOwnership
        /// <summary>
        /// 将CommandText发送到Connection，并使用CommandBehavior值之一生成一个SqlDataReader
        /// </summary>
        /// <param name="CmdType">指定如何解释命令字符串</param>
        ...
        #region 执行查询，并返回查询所返回的结果集中第一行的第一列。忽略其他列或行/参数：CommandType CmdType, string CmdText, OracleTransaction Transaction
        /// <summary>
        /// 执行查询，并返回查询所返回的结果集中第一行的第一列。忽略其他列或行。
        /// </summary>
        /// <param name="CmdType">指定如何解释命令字符串</param>
        ...
        {
            return this.ExecuteScalar(CmdType, CmdText, null, (OracleTransaction)Transaction);
        }
        #endregion

        #region 执行查询，并返回查询所返回的结果集中第一行的第一列。忽略其他列或行/参数：CommandType CmdType, string CmdText, OracleConnection[] CmdParameters
        /// <summary>
        /// 执行查询，并返回查询所返回的结果集中第一行的第一列。忽略其他列或行
        /// </summary>
        /// <param name="CmdType">指定如何解释命令字符串</param>
        ...
        #region 执行查询，并返回查询所返回的结果集中第一行的第一列。忽略其他列或行/参数：CommandType CmdType, string CmdText, OracleConnection[] CmdParameters, OracleTransaction Transaction
        /// <summary>
        /// 执行查询，并返回查询所返回的结果集中第一行的第一列。忽略其他列或行。
        /// </summary>
        /// <param name="CmdType">指定如何解释命令字符串</param>

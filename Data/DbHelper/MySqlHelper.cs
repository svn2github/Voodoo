...
{
    public class MySqlHelper : Voodoo.Data.IDbHelper
    {
        #region 预定义对象
        /// <summary>
        /// 数据库连接
        ...
        /// </summary>
        /// <param name="connStr"></param>
        public MySqlHelper(string connStr, int Times)
        {
            this.Conn = new MySqlConnection(connStr);
        ...
        /// <remarks></remarks> 
        public void Add(string ParamName, MySqlDbType MySqlDbType, object Value)
        {
            Cmd.Parameters.Add(new MySqlParameter(ParamName, MySqlDbType)).Value = Value == null ? "" : Value;
        }
        /// <summary> 
        ...
        /// <remarks></remarks> 
        public void Add(string ParamName, MySqlDbType MySqlDbType, object Value, bool NoNull)
        {
            Cmd.Parameters.Add(new MySqlParameter(ParamName, MySqlDbType)).Value = Value;
        }
        /// <summary> 
        ...
        /// <remarks></remarks> 
        public void Add(string ParamName, MySqlDbType MySqlDbType, object Value, int Size)
        {
            Cmd.Parameters.Add(new MySqlParameter(ParamName, MySqlDbType, Size)).Value = Value == null ? "" : Value;
        }
        /// <summary> 
        ...
        /// <param name="NoNull"></param> 
        /// <remarks></remarks> 
        public void Add(string ParamName, MySqlDbType MySqlDbType, object Value, int Size, bool NoNull)
        {
            Cmd.Parameters.Add(new MySqlParameter(ParamName, MySqlDbType, Size)).Value = Value;
        }
        /// <summary> 
        ...
        /// <remarks></remarks> 
        public void Add(string ParamName, MySqlDbType MySqlDbType, object Value, int Precision, int Scale)
        {
            MySqlParameter aa = new MySqlParameter(ParamName, MySqlDbType);
        ...
        private void CreateCmd(CommandType CmdType, string CmdText, DbParameter[] CmdParameters, MySqlTransaction Transaction)
        {
        ...
        {
            return this.ExecuteDataSet(CmdType, CmdText, null, (MySqlTransaction)Transaction);
        }
        #endregion
        ...
        {
            return this.ExecuteDataTable(CmdType, CmdText, null, (MySqlTransaction)Transaction);
        }
        #endregion
